...
public class Employee
{
	...
	Employee(String name,int id,Car car,Bike1 b)
	{
		this.name=name;
		this.id=id;
		this.car=car;
...
{
		Car c=new Car("TATA","TS456564PS","BIRLA");
		Bike1 b=new Bike1("Enfield","S45877g55",350,300000);
		Employee e=new Employee("Sundar",14562,c,b);
		...
		System.out.println(e.car.egno);
		System.out.println(e.car.comp);
